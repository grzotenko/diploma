...
class SocialNet(models.Model):
    id_fk = models.ForeignKey(Main, on_delete=models.CASCADE,related_name='socialnets')
...
class Contact(models.Model):
    id_fk = models.ForeignKey(Main, on_delete=models.CASCADE ,related_name='contacts')
